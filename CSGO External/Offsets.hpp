...
constexpr ptrdiff_t dwClientState = 0x58CCFC;
...
constexpr ptrdiff_t dwEntityList = 0x4D04A74;
constexpr ptrdiff_t dwForceAttack = 0x313613C;
constexpr ptrdiff_t dwForceAttack2 = 0x3136148;
constexpr ptrdiff_t dwForceBackward = 0x3136178;
constexpr ptrdiff_t dwForceForward = 0x3136154;
constexpr ptrdiff_t dwForceJump = 0x51A812C;
constexpr ptrdiff_t dwForceLeft = 0x313616C;
constexpr ptrdiff_t dwForceRight = 0x3136190;
constexpr ptrdiff_t dwGameDir = 0x632F70;
constexpr ptrdiff_t dwGameRulesProxy = 0x521A474;
constexpr ptrdiff_t dwGetAllClasses = 0xD178C4;
constexpr ptrdiff_t dwGlobalVars = 0x58CA00;
constexpr ptrdiff_t dwGlowObjectManager = 0x5244F98;
constexpr ptrdiff_t dwInput = 0x514FAC0;
constexpr ptrdiff_t dwInterfaceLinkList = 0x8C7BB4;
constexpr ptrdiff_t dwLocalPlayer = 0xCF2A3C;
constexpr ptrdiff_t dwMouseEnable = 0xCF8588;
constexpr ptrdiff_t dwMouseEnablePtr = 0xCF8558;
constexpr ptrdiff_t dwPlayerResource = 0x31344BC;
constexpr ptrdiff_t dwRadarBase = 0x51397D4;
constexpr ptrdiff_t dwSensitivity = 0xCF8424;
constexpr ptrdiff_t dwSensitivityPtr = 0xCF83F8;
constexpr ptrdiff_t dwSetClanTag = 0x896A0;
constexpr ptrdiff_t dwViewMatrix = 0x4CF64A4;
constexpr ptrdiff_t dwWeaponTable = 0x5150584;
constexpr ptrdiff_t dwWeaponTableIndex = 0x323C;
constexpr ptrdiff_t dwYawPtr = 0xCF81E8;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xCFD408;
constexpr ptrdiff_t dwbSendPackets = 0xD280A;
constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA6030;
constexpr ptrdiff_t force_update_spectator_glow = 0x393022;
constexpr ptrdiff_t interface_engine_cvar = 0x3E9EC;
constexpr ptrdiff_t is_c4_owner = 0x39F370;
constexpr ptrdiff_t m_bDormant = 0xED;
constexpr ptrdiff_t m_pStudioHdr = 0x294C;
constexpr ptrdiff_t m_pitchClassPtr = 0x5139A80;
constexpr ptrdiff_t m_yawClassPtr = 0xCF81E8;
constexpr ptrdiff_t model_ambient_min = 0x58FD1C;
constexpr ptrdiff_t set_abs_angles = 0x1CA790;
constexpr ptrdiff_t set_abs_origin = 0x1CA5D0;