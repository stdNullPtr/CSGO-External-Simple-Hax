...
constexpr ptrdiff_t dwEntityList = 0x4D08EF4;
constexpr ptrdiff_t dwForceAttack = 0x313A5B0;
constexpr ptrdiff_t dwForceAttack2 = 0x313A5BC;
constexpr ptrdiff_t dwForceBackward = 0x313A5F8;
constexpr ptrdiff_t dwForceForward = 0x313A604;
constexpr ptrdiff_t dwForceJump = 0x51AC5A8;
constexpr ptrdiff_t dwForceLeft = 0x313A61C;
constexpr ptrdiff_t dwForceRight = 0x313A610;
constexpr ptrdiff_t dwGameDir = 0x6376F0;
constexpr ptrdiff_t dwGameRulesProxy = 0x521E8EC;
constexpr ptrdiff_t dwGetAllClasses = 0xD1BCFC;
constexpr ptrdiff_t dwGlobalVars = 0x590A90;
constexpr ptrdiff_t dwGlowObjectManager = 0x5249348;
constexpr ptrdiff_t dwInput = 0x5153F40;
constexpr ptrdiff_t dwInterfaceLinkList = 0x8CAB44;
constexpr ptrdiff_t dwLocalPlayer = 0xCF6A4C;
constexpr ptrdiff_t dwMouseEnable = 0xCFC598;
constexpr ptrdiff_t dwMouseEnablePtr = 0xCFC568;
constexpr ptrdiff_t dwPlayerResource = 0x313893C;
constexpr ptrdiff_t dwRadarBase = 0x513DC54;
constexpr ptrdiff_t dwSensitivity = 0xCFC434;
constexpr ptrdiff_t dwSensitivityPtr = 0xCFC408;
constexpr ptrdiff_t dwSetClanTag = 0x89A10;
constexpr ptrdiff_t dwViewMatrix = 0x4CFA924;
constexpr ptrdiff_t dwWeaponTable = 0x5154A08;
constexpr ptrdiff_t dwWeaponTableIndex = 0x323C;
constexpr ptrdiff_t dwYawPtr = 0xCFC1F8;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD01418;
constexpr ptrdiff_t dwbSendPackets = 0xD2E8A;
constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA6030;
constexpr ptrdiff_t find_hud_element = 0x2B057300;
constexpr ptrdiff_t force_update_spectator_glow = 0x393522;
constexpr ptrdiff_t interface_engine_cvar = 0x3E9EC;
constexpr ptrdiff_t is_c4_owner = 0x39F780;
constexpr ptrdiff_t m_bDormant = 0xED;
constexpr ptrdiff_t m_flSpawnTime = 0xA360;
constexpr ptrdiff_t m_pStudioHdr = 0x294C;
constexpr ptrdiff_t m_pitchClassPtr = 0x513DF00;
constexpr ptrdiff_t m_yawClassPtr = 0xCFC1F8;
constexpr ptrdiff_t model_ambient_min = 0x593DAC;
constexpr ptrdiff_t set_abs_angles = 0x1CAA50;
constexpr ptrdiff_t set_abs_origin = 0x1CA890;
